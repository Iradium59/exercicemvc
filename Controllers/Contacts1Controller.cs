...
namespace ExerciceMVC.Controllers
{
    public class Contacts1Controller : Controller
    {
        ...
        public Contacts1Controller(ExerciceMVCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,Phone,RegisterDate")] Contact contact)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,Phone,RegisterDate")] Contact contact)
        {
            if (id != contact.Id)
            {
                return NotFound();
